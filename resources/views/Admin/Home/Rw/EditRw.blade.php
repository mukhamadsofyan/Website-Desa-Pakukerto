                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <h4 class="card-title">Input Data Rw DESA</h4>
                                    {{-- <p class="card-title-desc">Isi semua kolom di bawah untuk menambahkan entri blog
                                        baru.</p> --}}

                                    <form method="post" action="/updaterw/{{$rw->id}}"  enctype="multipart/form-data">
                                        @csrf
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select" name="dusun">
                                                ...
                                                <option value="Kemiri" {{ $rw->dusun == 'Kemiri' ? 'selected' : '' }}>Kemiri</option>
                                                <option value="Janti" {{ $rw->dusun == 'Janti' ? 'selected' : '' }}>Janti</option>
                                                <option value="Gendol" {{ $rw->dusun == 'Gendol' ? 'selected' : '' }}>Gendol</option>
                                                <option value="Pakunden" {{ $rw->dusun == 'Pakunden' ? 'selected' : '' }}>Pakunden</option>
                                                <option value="Mojolengko" {{ $rw->dusun == 'Mojolengko' ? 'selected' : '' }}>Mojolengko</option>
                                            </select>
                                        </div>
                                        <div class="mb-3">
                                            <label class="form-label">No Rw</label>
                                            <input type="number" class="form-control" name="no_rw" value="{{$rw->no_rw}}">
                                        </div>
