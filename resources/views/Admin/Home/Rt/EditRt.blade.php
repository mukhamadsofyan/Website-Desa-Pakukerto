                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-flex align-items-center justify-content-between">
                                <h4 class="mb-0">Form Edit Data Rt</h4>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form method="post" action="/updatert/{{$rt->id}}"  enctype="multipart/form-data">
                                        @csrf
                                         <div class="mb-3">
                                            <label class="form-label">Dusun</label>
                                            <input type="text" class="form-control"  value="{{ $rt->dusun }}" disabled>
                                        </div>
                                         <div class="mb-3">
                                            <label class="form-label">No Rw</label>
                                            <input type="text" class="form-control"  value="{{ $rt->rw->no_rw }}" disabled >
                                        </div>
                                        <div class="mb-3">
                                            <label class="form-label">No Rt</label>
                                            <input type="text" class="form-control" name="no_rt" id="no_rt" value="{{ $rt->no_rt }}">
                                        </div>
